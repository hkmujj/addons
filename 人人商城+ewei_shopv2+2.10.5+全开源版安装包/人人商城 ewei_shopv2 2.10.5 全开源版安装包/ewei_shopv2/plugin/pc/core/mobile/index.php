...
class Index_EweiShopV2Page extends PcMobilePage 
{
	...
	public function style($id) 
	{
		switch ($id) 
		{
			...
			case 8: return 'style-red';
			case 9: return "style-pink";
			case 10: return "style-orange";
			case 11: return "style-green";
			case 12: return "style-blue";
			case 13: return "style-purple";
			case 14: return "style-brown";
