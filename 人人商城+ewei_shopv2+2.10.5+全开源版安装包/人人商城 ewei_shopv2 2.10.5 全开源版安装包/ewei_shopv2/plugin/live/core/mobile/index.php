...
class Index_EweiShopV2Page extends PluginMobileLoginPage
{
	public function main()
	{
		...
		$recommend = pdo_fetchall('select id,title,thumb,livetime,subscribe,living from ' . tablename('ewei_shop_live') . ' where uniacid = ' . $uniacid . ' and status = 1 and recommend = 1 ');
