var KaoShi = {
	...
	// 预加载loading提示
	sloading:function(key) {
		var html = "<div id='kaoshi_loading_img' style='position:absolute;top:20%;left:45%;z-index:10000'><img src='"+KaoShi.web_root+"/addons/jiakao_system/common/loading.gif'></div>";
		if(key == 'y') {
			$("div#pic").html(html);
		}else{
			$("div#kaoshi_loading_img").remove();
		}
	...
	appendinfo:function(data)
	{
		...
		if(obj.pic_url != '')
		{
			var img = "<img style=\"height:100px\" src=\""+obj.pic_url+"\">";
			$("#pic").html(img);
		}
		//标签
