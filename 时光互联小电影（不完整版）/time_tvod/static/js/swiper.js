    ...
    var PhotoBrowser = function (params) {
        ...
        var navbarTemplate = pb.params.navbarTemplate ||
                            '<header class="bar bar-nav">' + 
                              '<a class="button button-link button-nav pull-left photo-browser-close-link' + (pb.params.type === 'popup' ?  " close-popup" : "") + '"><span class="icon icon-left"></span></a>' + 
        ...
        var photoTemplate = !pb.params.lazyLoading ? 
            (pb.params.photoTemplate || '<div class="photo-browser-slide swiper-slide"><span class="photo-browser-zoom-container"><img src="{{url}}" width="100%"></span></div>') : 
